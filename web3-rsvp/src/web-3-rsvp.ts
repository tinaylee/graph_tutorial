...
export function handleNewEventCreated(event: NewEventCreated): void {
	//load a new Event entity using the eventID and converting it into a hex string
	let newEvent = Event.load(event.params.eventID.toHex());
	if (newEvent == null) {
		//if event doesn't already exist, create the event and save the properties of the event
